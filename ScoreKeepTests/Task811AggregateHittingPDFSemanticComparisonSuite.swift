...
struct Task811AggregateHittingPDFSemanticComparisonSuite {
    ...
    func matchesValuesInOrder() throws {
        ...
        let expectedFields = [
            ...
            ExpectedField(name: "slg", value: "2.980"),
            ExpectedField(name: "ops", value: "3.475"),
    ...
    func opsAbove999RemainsCompleteInOrder() throws {
        ...
        let expectedFields = [
            ...
            ExpectedField(name: "avg", value: "1.000"),
            ExpectedField(name: "obp", value: ".737"),
            ExpectedField(name: "slg", value: "3.677"),
            ExpectedField(name: "ops", value: "4.414"),
    ...
    func multiDigitCountValuesRemainCompleteInOrder() throws {
        ...
        let expectedFields = [
            ...
            ExpectedField(name: "slg", value: "5.880"),
            ExpectedField(name: "ops", value: "6.423"),
