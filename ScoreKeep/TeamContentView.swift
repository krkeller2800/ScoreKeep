...
struct TeamContentView: View {
    ...
    var body: some View {
        NavigationStack(path: $navigationPath) {
            TeamView(searchString: searchText, sortOrder: sortOrder).navigationTitle(Text("Add or Edit a Team"))
                .navigationDestination(for: Team.self) { team in
                    EditTeamView(navigationPath: $navigationPath, team: team).navigationTitle(Text("Update Team"))
