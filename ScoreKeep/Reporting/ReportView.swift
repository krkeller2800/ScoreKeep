...
//                let avgSize = geometry.size.width / 32
    ...
    private var hittingStatsHeader: some View {
        HStack {
            ...
            scorebookHeaderCell("Name", semantic: true, scaleFactor: 0.5)
                .frame(width:125)
            scorebookHeaderCell("AB", semantic: true, scaleFactor: 0.5)
                .frame(maxWidth:.infinity)
            ...
            hittingRateHeader("OPS")
                .frame(width: rateColumnWidth)
            scorebookHeaderCell("R", semantic: true, scaleFactor: 0.5)
                .frame(maxWidth:.infinity)
            ...
            scorebookHeaderCell("3B", semantic: true, scaleFactor: 0.5)
                .frame(maxWidth:.infinity)
            scorebookHeaderCell("SH", semantic: true, scaleFactor: 0.5)
                .frame(maxWidth:.infinity)
            scorebookHeaderCell("SF", semantic: true, scaleFactor: 0.5)
                .frame(maxWidth:.infinity)
            Text("").frame(maxWidth:5)
        }
        .frame(height: 34)
