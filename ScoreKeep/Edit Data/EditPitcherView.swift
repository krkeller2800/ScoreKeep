            ...
            VStack() {
                List {
                    HStack () {
                        ...
                        scorebookHeaderCell("Start Inning")
                            .frame(maxWidth:.infinity,maxHeight: 55)
                        scorebookHeaderCell("Start Outs")
                            .frame(maxWidth:.infinity,maxHeight: 55)
                        scorebookHeaderCell("Num of Batters")
                            .frame(maxWidth:.infinity,maxHeight: 55)
                        scorebookHeaderCell("End Inning")
                            .frame(maxWidth:.infinity,maxHeight: 55)
                        scorebookHeaderCell("End Outs")
                            .frame(maxWidth:.infinity,maxHeight: 55)
                        scorebookHeaderCell("Num of Batters")
                            .frame(maxWidth:.infinity,maxHeight: 55)
                        Spacer(minLength: 5)
