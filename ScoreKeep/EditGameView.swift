    ...
    var body: some View {
        Form {
            HStack{
                ...
                Spacer()
                 Text("Field Name").frame(maxWidth: .infinity, alignment: .center).border(.gray)
                    .foregroundColor(.red).bold().background(.yellow.opacity(0.3))
                Spacer()
                Text("Every One Hit").frame(maxWidth: .infinity, alignment: .center).border(.gray)
                    .foregroundColor(.red).bold().background(.yellow.opacity(0.3))
                Spacer()
                Text("Innings per Game").frame(maxWidth: .infinity, alignment: .center).border(.gray)
                    .foregroundColor(.red).bold().background(.yellow.opacity(0.3))
                Spacer()
                Text("Visiting Team").frame(maxWidth: .infinity, alignment: .center).border(.gray)
                    .foregroundColor(.red).bold().background(.yellow.opacity(0.3))
                Spacer()
                Text("Home Team").frame(maxWidth: .infinity, alignment: .center).border(.gray)
                    .foregroundColor(.red).bold().background(.yellow.opacity(0.3))
                Spacer()
            }
            HStack{
